...
var ruleNames =  [ "file", "formula", "constant", "negatiation", "conjunction", 
...
FormulaContext.prototype.constant = function() {
...
function ConstantContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = LogicParser.RULE_constant;
    return this;
}
...
LogicParser.ConstantContext = ConstantContext;

LogicParser.prototype.constant = function() {

    var localctx = new ConstantContext(this, this._ctx, this.state);
    this.enterRule(localctx, 4, LogicParser.RULE_constant);
...
NegatiationContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LogicVisitor ) {
        return visitor.visitNegatiation(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
EqivalencioContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LogicVisitor ) {
        return visitor.visitEqivalencio(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
Binary_coupleContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LogicVisitor ) {
        return visitor.visitBinary_couple(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
Unary_formulaContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LogicVisitor ) {
        return visitor.visitUnary_formula(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
Binary_formulaContext.prototype.accept = function(visitor) {
    if ( visitor instanceof LogicVisitor ) {
        return visitor.visitBinary_formula(this);
    } else {
        return visitor.visitChildren(this);
    }
};
